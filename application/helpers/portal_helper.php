...
{
	$CI =& get_instance();
    if(!$CI->session->userdata('login') == 'PortalOke'){
        redirect('/');
    }
}
...
{
	$CI =& get_instance();
    if(!$CI->session->userdata('login') == 'OKM'){
        redirect('/');
    }
}
...
if ( ! function_exists('__session')) {
 ...
 if ( ! function_exists('__bidang')) {
	function __bidang( $config ) {
	   $CI =& get_instance();
 ...
 if ( ! function_exists('__css')) {
	function __css( $css ) {
	   return site_url('public/css/'.$css);
	}
 }

 if ( ! function_exists('__js')) {
	function __js( $js ) {
	   return site_url('public/js/'.$js);
	}
 }

 if ( ! function_exists('__img')) {
	function __img( $file ) {
	   return site_url('public/img/'.$file);
	}
 }
