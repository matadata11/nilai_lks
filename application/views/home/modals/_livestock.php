                                        ...
                                        <table class="table table-bordered table-hover table-sm" id="" style="width:100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <td class="align-middle text-center" style="max-width:10px;">
                                                    ...
                                                    <td  style="width:8%;">
                                                        <input type="text" name="livestock2" id="livestock3" class="form-control" >
                                                    </td>
                                                    <td  style="width:8%;">
                                                    ...
                                                    <td  style="width:8%;">
                                                        <input type="text" name="livestock6" id="livestock6" class="form-control" >
                                                    </td>
                                                    <td style="width:8%;">
                                                        <input type="text" name="j_livestock" id="livestocka"  class="form-control" readonly>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
