                                        ...
                                        <table class="table table-bordered table-hover table-sm" id="" style="width:100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <select name="peserta_id" id="id_peserta" class="form-control" required="">
                                                    ...
                                                    <td  style="width:8%;">
                                                        <input type="text" name="refrigeration1" id="refrigeration1" class="form-control" >
                                                    </td>
                                                    <td  style="width:8%;">
                                                        <input type="text" name="refrigeration2" id="refrigeration2" class="form-control" >
                                                    </td>
                                                    <td style="width:8%;">
                                                        <input type="text" name="refrigeration3" id="refrigeration3" class="form-control" >
                                                    </td>
                                                    <td style="width:8%;">
                                                        <input type="text" name="refrigeration1 " id="refrigeration1 4" class="form-control" >
                                                    </td>
                                                    <td  style="width:10%;">
                                                        <input type="text" name="j_refrigeration" id="refrigerationa" class="form-control" >
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
