    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width:90%;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Pemasaran Daring (Online Marketing)</h5>
                                        ...
                                        <table class="table table-bordered table-hover table-sm" id="" style="width:100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="align-middle text-center" rowspan="2"> Nilai <br> BP </th>
                                                    <th class="align-middle text-center" rowspan="2">Nilai <br> CJM</th>
                                                    <th class="align-middle text-center" rowspan="2">Nilai <br> Lainnya</th>
