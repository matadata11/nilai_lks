    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width:90%;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Welding</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span class="text-dark" aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
            <form method="post" action="<?=site_url('add-welding')?>">
                                        ...
                                        <table class="table table-bordered table-hover table-sm" id="" style="width:100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="align-middle text-center" rowspan="2">Nilai <b>2-F</b> <br>40%</th>
                                                    <th class="align-middle text-center" rowspan="2">Nilai <b>3-G</b> <br>60%</th>
                                                    <th class="align-middle text-center" rowspan="2">NILAI AKHIR<br>100%</th>
                                                </tr>
