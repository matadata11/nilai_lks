    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width:90%;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Restaurant Service</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span class="text-dark" aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
            <form method="post" action="<?=site_url('add-restaurant')?>">
                                        ...
                                        <table class="table table-bordered table-hover table-sm" id="" style="width:100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="align-middle text-center" rowspan="2">NILAI TOTAL PEROLEHAN</th>
                                                    <th class="align-middle text-center" rowspan="2">NILAI ASPEK <br>INDIVIDUAL TASK</th>
                                                    <th class="align-middle text-center" rowspan="2">NILAI ASPEK <br>SERVICE</th>
                                            ...
                                            <tbody>
                                                ...
                                                <td class="align-middle text-center" style="max-width:8px;">
                                                    ...
                                                    <td  style="width:10%;">
                                                        <input type="text" name="restaurant1" id="restaurant1" class="form-control" >
                                                    </td>
                                                    <td  style="width:10%;">
                                                        <input type="text" name="restaurant2" id="restaurant2" class="form-control" >
                                                    </td>
                                                    <td style="width:10%;">
                                                        <input type="text" name="restaurant3" id="restaurant3" class="form-control" >
                                                    </td>
                                                    <td  style="width:10%;">
                                                        <input type="text" name="j_restaurant" id="restauranta" class="form-control" >
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
