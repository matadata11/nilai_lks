...
class Pengguna extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('wilayah/M_kab', 'kab');
	...
	public function register()
	{
		if(isset($_POST['submit'])){
			...
			$this->email->to($email);
			$this->email->subject("Verifikasi Akun Verval Kurikulum. Bidang Pembinaan SMK Dinas Pendidikan Aceh");
